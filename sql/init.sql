...
CREATE TABLE IF NOT EXISTS games (
    ...
    FOREIGN KEY (winner) REFERENCES deck.id ON DELETE RESTRICT ON UPDATE RESTRICT,
    FOREIGN KEY (loser) REFERENCES decks.id ON DELETE RESTRCIT ON UPDATE RESTRICT
);
